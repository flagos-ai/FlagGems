...
class Benchmark:
    ...
    def _cuda_graph_latency_cache_key(
        ...
        return (
            ...
            os.environ.get("FLAGGEMS_MM_QWEN_P32768_BF16_FALLBACK", "1"),
            os.environ.get("FLAGGEMS_BENCH_MM_COMPARE_BF16_TRITON", "0"),
            os.environ.get("FLAGGEMS_BENCH_MM_FORCE_BF16_TRITON", "0"),
            batch_reps,
            reps,
