...
class FusedMarlinMoEBenchmarkFp8WeightMXQ(base.Benchmark):
    """MXQ/Qwen W(fp8)A16 benchmark against vLLM Marlin W(fp8)A16."""
    ...
    def _get_quantized_weights(
        ...
        w1_q_fp8, w1_scale_fp8 = _wna16_quantize_per_expert_fp8(w1_fp)
        w2_q_fp8, w2_scale_fp8 = _wna16_quantize_per_expert_fp8(w2_fp)
...
def _vllm_baseline_fp8(
    ...
    """Baseline: vLLM CUDA Marlin fused_marlin_moe W(fp8)A16."""
    return vllm_fused_marlin_moe(
        hidden_states=hidden_states,
        w1=w1_q_marlin,
        w2=w2_q_marlin,
...
def test_fused_marlin_moe_fp8_weight_mxq():
    ...
    Both backends use the same E4M3 weights and per-group-128 scales.
    """
