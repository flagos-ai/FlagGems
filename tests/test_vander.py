...
def test_vander_complex(dtype):
    # The Triton kernel cannot handle complex numbers; it must raise so the
    # dispatcher falls back to ATen's complex-capable implementation.
