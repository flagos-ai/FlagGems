...
def test_binary_cross_entropy_with_logits(shape, dtype):
    ...
    res_out = flag_gems.binary_cross_entropy_with_logits(inp, target, reduction=0)
...
def test_binary_cross_entropy_with_logits_mean(shape, dtype):
    ...
    res_out = flag_gems.binary_cross_entropy_with_logits(inp, target, reduction=1)
...
def test_binary_cross_entropy_with_logits_sum(shape, dtype):
    ...
    res_out = flag_gems.binary_cross_entropy_with_logits(inp, target, reduction=2)
...
def test_binary_cross_entropy_with_logits_weight(shape, dtype):
    ...
    res_out = flag_gems.binary_cross_entropy_with_logits(
