...
# binary_cross_entropy_with_logits uses intermediate fp32 accumulation only;
# float16/bf16 are not numerically stable enough for the reference comparison
# which upcasts to fp64 internally.
