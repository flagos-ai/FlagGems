...
@pytest.mark.parametrize("EmbeddingSize", [1024] if cfg.TO_CPU or cfg.QUICK_MODE else [4096])
...
@pytest.mark.parametrize("scale_grad_by_freq", [False] if cfg.QUICK_MODE else [True, False])
