...
def test_hardsigmoid_backward(shape, dtype):
    """Test hardsigmoid_backward with various shapes."""
    ...
    ref_grad_input = torch.ops.aten.hardsigmoid_backward(ref_grad_output, ref_x)

    with flag_gems.use_gems():
        res_grad_input = torch.ops.aten.hardsigmoid_backward(grad_output, x)
