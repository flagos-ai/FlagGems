...
SHAPE_CONV_TRANSPOSE2D = [
    ...
    ((1, 2, 4, 4), (2, 1, 3, 3), 1),  # basic
    ((2, 3, 6, 6), (3, 1, 3, 3), 1),  # batch > 1
    ((1, 4, 8, 8), (4, 1, 3, 5), 1),  # non-square kernel (3x5)
    ((1, 4, 8, 8), (4, 1, 5, 3), 1),  # non-square kernel (5x3)
    ((1, 3, 8, 16), (3, 2, 3, 3), 1),  # non-square input
    ((1, 4, 8, 8), (4, 2, 3, 3), 2),  # groups=2 (C_in=4, C_out=4)
]
