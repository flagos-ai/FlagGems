...
@pytest.mark.parametrize(
    ...
    "dilation, dtype",
    SUPPORTED_CONV_TRANSPOSE2D_CASES[:2] if cfg.QUICK_MODE else SUPPORTED_CONV_TRANSPOSE2D_CASES,
)
...
@pytest.mark.parametrize(
    "input_shape, weight_shape, use_bias, stride, padding, output_padding, groups, "
    "dilation, dtype",
    ADDITIONAL_CONV_TRANSPOSE2D_CASES[:2] if cfg.QUICK_MODE else ADDITIONAL_CONV_TRANSPOSE2D_CASES,
)
