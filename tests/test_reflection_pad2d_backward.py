...
@pytest.mark.parametrize(
    "padding", [(1, 1, 1, 1), (2, 2, 0, 0), (0, 0, 3, 3), (3, 1, 2, 4)]
)
...
def test_reflection_pad2d_backward(shape, padding, dtype):
    ...
    ref_grad_input = torch.ops.aten.reflection_pad2d_backward(
        ref_grad, ref_input, padding
    )

    with flag_gems.use_gems():
        res_grad_input = torch.ops.aten.reflection_pad2d_backward(
