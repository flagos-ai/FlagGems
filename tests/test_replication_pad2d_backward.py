...
def test_replication_pad2d_backward(shape, padding, dtype):
    """Test replication_pad2d_backward with various shapes and padding."""
    ...
    ref_grad_input = torch.ops.aten.replication_pad2d_backward(ref_grad, ref_input, padding)

    with flag_gems.use_gems():
        res_grad_input = torch.ops.aten.replication_pad2d_backward(grad_output, input, padding)
