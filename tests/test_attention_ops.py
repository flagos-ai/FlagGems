...
def test_sparse_attention(batch, seq_len, kv_len, topk, heads, dim, seed):
    ...
    ref_attn_sink = to_reference(attn_sink, False)
    ref_topk_idxs = to_reference(topk_idxs, False)
    ...
    gems_assert_close(gems_result, torch_result, torch.bfloat16, atol=1e-3)
