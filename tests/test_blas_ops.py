...
MNK_SHAPES = (
    ...
    [
        ...
        (7168, 2048, 1024),
        (16384, 2048, 1024),
        # 3.d MoE::shared_expert_gate, [M, K=2048, N=1] TODO: origin is wrong!
        #(1, 1, 2048),
        #(2, 1, 2048),
        #(4, 1, 2048),
        #(8, 1, 2048),
...
'''
#FLOAT_DTYPES = [torch.bfloat16, torch.float32] if QUICK_MODE else FLOAT_DTYPES
FLOAT_DTYPES = [torch.bfloat16] if QUICK_MODE else FLOAT_DTYPES
