...
# Test shapes for inplace bitwise right shift, covering broadcasting dimensions
if cfg.QUICK_MODE:
    # Minimal set for quick mode
    INPLACE_BITWISE_SHAPES = [
        ((512, 1024), (512, 1024)),
    ]
else:
    # Cover broadcasting and scalar edge cases for inplace
    INPLACE_BITWISE_SHAPES = [
        ((512, 1024), (512, 1024)),
        ((256, 512), (1, 512)),
        ((256, 512), (256, 1)),
