...
# Reference implementation for dynamic 4-bit weight quantization and packing
...
def test_accuracy_dyn_quant_pack_4bit_weight(shape, dtype, group_size):
    ...
    gems_assert_close(res_scales, ref_scales, dtype=torch.float32, atol=1e-2)

    # Compare zeros (should always be 8)
    gems_assert_equal(res_zeros, ref_zeros)
