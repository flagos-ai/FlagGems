...
class FlagGemsOperatorExtractor:
    ...
    # 所有支持的后端
    ALL_BACKENDS = [
        'NVIDIA', 'CAMBRICON', 'METAX', 'ILUVATAR', 'MTHREADS',
        'KUNLUNXIN', 'HYGON', 'AMD', 'AIPU', 'ASCEND',
        'TSINGMICRO', 'SUNRISE', 'ENFLAME'
    ]
    
    # 算子类别映射
    CATEGORY_MAP = {
        # 激活函数
        'relu': '激活函数', 'relu6': '激活函数', 'relu_': '激活函数',
        'silu': '激活函数', 'silu_': '激活函数', 'silu_backward': '激活函数',
        'gelu': '激活函数', 'gelu_': '激活函数', 'gelu_backward': '激活函数',
        'sigmoid': '激活函数', 'sigmoid_': '激活函数', 'sigmoid_backward': '激活函数',
        'tanh': '激活函数', 'tanh_': '激活函数', 'tanh_backward': '激活函数',
        'elu': '激活函数', 'elu_': '激活函数', 'elu_backward': '激活函数',
        'celu': '激活函数', 'celu_': '激活函数',
        'selu': '激活函数', 'selu_': '激活函数',
        'softplus': '激活函数', 'softshrink': '激活函数', 'hardshrink': '激活函数',
        'hardsigmoid': '激活函数', 'hardtanh': '激活函数', 'prelu': '激活函数',
        'rrelu_with_noise_backward': '激活函数',
        'gelu_and_mul': '激活函数', 'silu_and_mul': '激活函数',
        'geglu': '激活函数', 'reglu': '激活函数', 'swiglu': '激活函数',
        
        # 数学运算
        'abs': '数学运算', 'abs_': '数学运算', 'absolute': '数学运算',
        'acos': '数学运算', 'asin': '数学运算', 'atan': '数学运算', 'atan_': '数学运算',
        'cos': '数学运算', 'cos_': '数学运算', 'sin': '数学运算', 'sin_': '数学运算',
        'exp': '数学运算', 'exp_': '数学运算', 'exp2': '数学运算', 'exp2_': '数学运算',
        'log': '数学运算', 'log1p_': '数学运算', 'log_sigmoid': '数学运算',
        'sqrt': '数学运算', 'sqrt_': '数学运算', 'rsqrt': '数学运算', 'rsqrt_': '数学运算',
        'pow': '数学运算', 'pow_': '数学运算',
        'neg': '数学运算', 'neg_': '数学运算',
        'reciprocal': '数学运算', 'reciprocal_': '数学运算',
        'erf': '数学运算', 'erf_': '数学运算', 'erfinv': '数学运算',
        'i0': '数学运算', 'i0_': '数学运算', 'special_i0e': '数学运算', 'special_i1': '数学运算',
        'hypot': '数学运算', 'logaddexp': '数学运算', 'logit': '数学运算', 'logit_': '数学运算',
        'digamma_': '数学运算', 'sgn_': '数学运算', 'polar': '数学运算',
        'arcsinh': '数学运算', 'arcsinh_': '数学运算', 'arctanh_': '数学运算', 'asinh_': '数学运算',
        'tan': '数学运算', 'tan_': '数学运算', 'sinh_': '数学运算', 'angle': '数学运算',
        
        # 归一化
        'layer_norm': '归一化', 'native_layer_norm': '归一化', 'native_layer_norm_backward': '归一化',
        'batch_norm': '归一化', 'native_batch_norm': '归一化', 'native_batch_norm_backward': '归一化',
        'group_norm': '归一化', 'native_group_norm': '归一化', 'native_group_norm_backward': '归一化',
        'rms_norm': '归一化', 'instance_norm': '归一化',
        'skip_layernorm': '归一化', 'fused_add_rms_norm': '归一化',
        'weight_norm': '归一化', 'weight_norm_interface': '归一化', '_weight_norm_interface_backward': '归一化',
        
        # 注意力机制
        'flash_attention_forward': '注意力机制', '_flash_attention_forward': '注意力机制',
        'flash_attn_varlen_func': '注意力机制', 'scaled_dot_product_attention': '注意力机制',
        'scaled_dot_product_attention_backward': '注意力机制',
        'softmax': '注意力机制', '_softmax': '注意力机制', '_softmax_backward_data': '注意力机制',
        'safe_softmax': '注意力机制', '_safe_softmax': '注意力机制',
        'log_softmax': '注意力机制', '_log_softmax': '注意力机制', '_log_softmax_backward_data': '注意力机制',
        'scaled_softmax': '注意力机制', 'scaled_softmax_backward': '注意力机制', 'scaled_softmax_forward': '注意力机制',
        'flash_mla': '注意力机制', 'apply_rotary_pos_emb': '注意力机制',
        
        # 矩阵运算
        'mm': '矩阵运算', 'bmm': '矩阵运算', 'addmm': '矩阵运算', 'addmm_out': '矩阵运算',
        'addmv': '矩阵运算', 'addmv_out': '矩阵运算', 'addr': '矩阵运算',
        'matmul': '矩阵运算', 'mv': '矩阵运算', 'dot': '矩阵运算', 'vdot': '矩阵运算',
        'baddbmm': '矩阵运算', 'baddbmm_backward': '矩阵运算',
        'linear': '矩阵运算', 'cutlass_scaled_mm': '矩阵运算',
        'w8a8_block_fp8_matmul': '矩阵运算', 'outer': '矩阵运算',
        
        # 归约运算
        'sum': '归约运算', 'mean': '归约运算', 'max': '归约运算', 'min': '归约运算',
        'prod': '归约运算', 'argmax': '归约运算', 'argmin': '归约运算',
        'cumsum': '归约运算', 'cummax': '归约运算', 'cummin': '归约运算',
        'all': '归约运算', 'any': '归约运算', 'amax': '归约运算', 'amin': '归约运算',
        'std': '归约运算', 'var_mean': '归约运算', 'vector_norm': '归约运算',
        'linalg_vector_norm': '归约运算', 'allclose': '归约运算',
        'count_nonzero': '归约运算', 'nonzero': '归约运算',
        
        # 卷积池化
        'conv1d': '卷积池化', 'conv2d': '卷积池化', 'conv3d': '卷积池化',
        'avg_pool2d': '卷积池化', 'avg_pool2d_backward': '卷积池化',
        'max_pool2d': '卷积池化', 'max_pool2d_backward': '卷积池化',
        'max_pool2d_with_indices': '卷积池化',
        'conv_depthwise2d': '卷积池化',
        
        # 张量操作
        'cat': '张量操作', 'stack': '张量操作', 'vstack': '张量操作', 'hstack': '张量操作',
        'contiguous': '张量操作', 'alias_copy': '张量操作', 'to_copy': '张量操作',
        'tril': '张量操作', 'triu': '张量操作', 'triu_': '张量操作',
        'diag': '张量操作', 'diag_embed': '张量操作', 'diagonal_backward': '张量操作',
        'flip': '张量操作', 'pixel_unshuffle': '张量操作',
        'slice_backward': '张量操作', 'slice_scatter': '张量操作', 'select_scatter': '张量操作',
        'unfold_backward': '张量操作',
        
        # 索引操作
        'index': '索引操作', 'gather': '索引操作', 'gather_backward': '索引操作',
        'scatter': '索引操作', 'scatter_': '索引操作', 'scatter_add_': '索引操作',
        'index_select': '索引操作', 'index_add': '索引操作', 'index_add_': '索引操作',
        'index_put': '索引操作', 'index_put_': '索引操作',
        'masked_fill': '索引操作', 'masked_fill_': '索引操作',
        'masked_select': '索引操作', 'masked_scatter': '索引操作', 'masked_scatter_': '索引操作',
        'select_backward': '索引操作',
        'where': '索引操作',
        
        # 比较运算
        'eq': '比较运算', 'ne': '比较运算', 'equal': '比较运算',
        'gt': '比较运算', 'lt': '比较运算', 'ge': '比较运算', 'le': '比较运算',
        'isclose': '比较运算', 'isfinite': '比较运算', 'isinf': '比较运算', 'isnan': '比较运算', 'isin': '比较运算',
        'maximum': '比较运算', 'minimum': '比较运算', 'fmin': '比较运算',
        
        # 逻辑运算
        'logical_and': '逻辑运算', 'logical_and_': '逻辑运算',
        'logical_or': '逻辑运算', 'logical_or_': '逻辑运算',
        'logical_not': '逻辑运算', 'logical_xor': '逻辑运算',
        
        # 位运算
        'bitwise_and': '位运算', 'bitwise_and_': '位运算',
        'bitwise_or': '位运算', 'bitwise_or_': '位运算',
        'bitwise_not': '位运算', 'bitwise_not_': '位运算',
        'bitwise_left_shift': '位运算', 'bitwise_right_shift': '位运算',
        
        # 算术运算
        'add': '算术运算', 'add_': '算术运算',
        'sub': '算术运算', 'sub_': '算术运算',
        'mul': '算术运算', 'mul_': '算术运算',
        'div': '算术运算', 'div_': '算术运算', 'divide': '算术运算', 'divide_': '算术运算',
        'addcdiv': '算术运算', 'addcmul': '算术运算',
        'true_divide': '算术运算', 'true_divide_': '算术运算',
        'floor_divide': '算术运算', 'floor_divide_': '算术运算',
        'remainder': '算术运算', 'remainder_': '算术运算',
        'lerp': '算术运算', 'lerp_': '算术运算',
        'clamp': '算术运算', 'clamp_': '算术运算', 'clamp_min': '算术运算', 'clamp_min_': '算术运算',
        'ceil': '算术运算', 'ceil_': '算术运算', 'ceil_out': '算术运算', 'floor_': '算术运算',
        'zero': '算术运算', 'zero_': '算术运算',
        
        # 损失函数
        'cross_entropy_loss': '损失函数', 'mse_loss': '损失函数',
        'nll_loss': '损失函数', 'nll_loss2d': '损失函数', 'nll_loss_nd': '损失函数',
        'nll_loss2d_backward': '损失函数', 'nll_loss2d_forward': '损失函数',
        'nll_loss_backward': '损失函数', 'nll_loss_forward': '损失函数',
        'nll_loss_nd_backward': '损失函数', 'nll_loss_nd_forward': '损失函数',
        'margin_ranking_loss': '损失函数', 'soft_margin_loss': '损失函数',
        
        # Dropout
        'dropout': 'Dropout', 'native_dropout': 'Dropout', 'native_dropout_backward': 'Dropout',
        
        # Embedding
        'embedding': 'Embedding', 'embedding_backward': 'Embedding', 'embedding_dense_backward': 'Embedding',
        'one_hot': 'Embedding',
        
        # 随机采样
        'rand': '随机采样', 'rand_like': '随机采样',
        'randn': '随机采样', 'randn_like': '随机采样',
        'multinomial': '随机采样', 'randperm': '随机采样',
        'normal': '随机采样', 'normal_': '随机采样', 'uniform_': '随机采样',
        'exponential_': '随机采样',
        
        # 序列生成
        'arange': '序列生成', 'linspace': '序列生成', 'logspace': '序列生成',
        
        # 张量构造
        'zeros': '张量构造', 'zeros_like': '张量构造',
        'ones': '张量构造', 'ones_like': '张量构造',
        'full': '张量构造', 'full_like': '张量构造', 'eye': '张量构造',
        
        # 张量填充
        'fill': '张量填充', 'fill_': '张量填充',
        'constant_pad_nd': '张量填充', 'pad': '张量填充',
        'reflection_pad1d': '张量填充', 'reflection_pad2d': '张量填充',
        'replication_pad1d': '张量填充', 'replication_pad3d': '张量填充',
        
        # 上下采样
        'upsample_nearest1d': '上下采样', 'upsample_nearest2d': '上下采样', 'upsample_nearest3d': '上下采样',
        'upsample_bicubic2d': '上下采样', 'upsample_bicubic2d_aa': '上下采样',
        'upsample_linear1d': '上下采样', '_upsample_nearest_exact1d': '上下采样',
        
        # 特殊操作
        'unique': '特殊操作', '_unique2': '特殊操作',
        'topk': '特殊操作', 'topk_softmax': '特殊操作', 'sort': '特殊操作',
        'grouped_topk': '特殊操作', 'quantile': '特殊操作',
        'trace': '特殊操作', 'kron': '特殊操作',
        'resolve_conj': '特殊操作', 'resolve_neg': '特殊操作', 'conj_physical': '特殊操作',
        'lift_fresh_copy': '特殊操作', 'bincount': '特殊操作',
        '_functional_sym_constrain_range_for_size': '特殊操作',
        'threshold': '特殊操作', 'threshold_backward': '特殊操作',
        't_copy': '特殊操作', 'repeat': '特殊操作', 'repeat_interleave': '特殊操作', 'tile': '特殊操作',
        
        # MoE
        'fused_moe': 'MoE', 'moe_sum': 'MoE', 'moe_align_block_size': 'MoE',
        'per_token_group_quant_fp8': 'MoE',
        
        # RWKV
        'rwkv_ka_fusion': 'RWKV', 'rwkv_mm_sparsity': 'RWKV',
    }
    ...
    def get_op_file(self, op_name):
        ...
        base_name = op_name.replace('native_', '').replace('_backward', '').replace('_out', '')
                ...
                if line.startswith('@pytest.mark.'):
                    ...
                    while i < len(lines) and lines[i].strip().startswith('@pytest.mark.'):
                        ...
                        if 'skipif' in mark_line and 'vendor_name' in mark_line:
                            match_eq = re.search(r'vendor_name\s*==\s*"(\w+)"', mark_line)
                            if match_eq:
                        ...
                        if 'parametrize' in mark_line:
                            match = re.search(r'parametrize\("([^"]+)",\s*([\w_\[\],\s]+)', mark_line)
                            if match:
                    ...
                    if i < len(lines) and 'def test_' in lines[i]:
                        ...
                        if func_match:
                            ...
                            for mark in marks_block:
                                if mark.startswith('@pytest.mark.') and \
                                   all(x not in mark for x in ['parametrize', 'skip', 'inplace']):
                            ...
                            if op_mark:
                                operators[op_mark].append({
                                    ...
                                    'dtypes': parametrize_info.get('dtype', 'FLOAT_DTYPES'),
                                    'shapes': parametrize_info.get('shape', 'POINTWISE_SHAPES'),
    ...
    def generate_markdown_table(self, operators, vendor_skip_stats):
        ...
        for category in sorted(operators_by_category.keys()):
            lines.append(f"\n### {category}\n")
            lines.append("\n| 算子名称 | 算子类别 | 算子所在文件 | 算子测例 | 数据类型 | 形状 | 测试文件 | 正确性测试命令 | 性能测试命令 | 支持的后端 |\n")
            lines.append("|----------|----------|--------------|----------|----------|------|----------|----------------|--------------|----------|\n")
            ...
            for op_name, tests in sorted(operators_by_category[category]):
                for test_info in tests:
                    ...
                    lines.append(f"| {op_name} | {category} | {op_file} | {test_name} | {test_info['dtypes']} | {test_info['shapes']} | {test_info['test_file']} | {correct_cmd} | {perf_cmd} | {backend_support} |\n")
    ...
    def generate_csv(self, operators, vendor_skip_stats):
        ...
        for op_name, tests in sorted(operators.items()):
            ...
            for test_info in tests:
                skip_vendors = test_info.get('skip_vendors', [])
                backend_support = "全部后端" if len(skip_vendors) == 0 else f"跳过{','.join(skip_vendors)}"
                ...
                output.write(f'{op_name},{category},{op_file},{test_name},{test_info["dtypes"]},{test_info["shapes"]},{test_info["test_file"]},{correct_cmd},{perf_cmd},{backend_support},{is_skip}\n')
...
def main():
    ...
    parser.add_argument('--dual-stats', action='store_true', 
    ...
    if args.output:
        stats_data = {
            ...
            "tested_dimension": {
                ...
                "category_distribution": dict(sorted(category_count.items(), key=lambda x: -x[1])),
            },
            "diff_analysis": {
                "both_count": len(both),
