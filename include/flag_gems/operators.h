...
at::Tensor add_tensor(const at::Tensor &self, const at::Tensor &other,
                      const at::Scalar &alpha = 1);
// add.Scalar(Tensor self, Scalar other, Scalar alpha=1) -> Tensor
at::Tensor add_scalar(const at::Tensor &self, const at::Scalar &other,
                      const at::Scalar &alpha = 1);
// add_.Tensor(Tensor(a!) self, Tensor other, *, Scalar alpha=1) -> Tensor(a!)
at::Tensor &add_tensor_inplace(at::Tensor &self, const at::Tensor &other,
                               const at::Scalar &alpha = 1);
// add_.Scalar(Tensor(a!) self, Scalar other, Scalar alpha=1) -> Tensor(a!)
at::Tensor &add_scalar_inplace(at::Tensor &self, const at::Scalar &other,
                               const at::Scalar &alpha = 1);
