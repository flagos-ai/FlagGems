...
|---|-----|------|---------|--------|-----------|------|
| 2 | [#1749](https://github.com/flagos-ai/FlagGems/pull/1749) | logsumexp | ✅ GREEN | **2.5-6.7x** | ✅ 已贴 | PR有问题：大量删除已注册算子 | done
| 3 | [#1757](https://github.com/flagos-ai/FlagGems/pull/1757) | poisson | ✅ GREEN | 未测 | ❌ | 没有 rebase 到 master | done
| 4 | [#1725](https://github.com/flagos-ai/FlagGems/pull/1725) | concatenate | ⏳ CLA | **1.1-1.4x** | ✅ 已贴 | __init__.py 合并冲突及小改动意见 |  没有真的kernel
