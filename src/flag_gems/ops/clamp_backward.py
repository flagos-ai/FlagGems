...
def clamp_tensor_backward(grad_output: torch.Tensor, input: torch.Tensor, min_val: torch.Tensor, max_val: torch.Tensor):
    return clamp_tensor_backward_kernel(grad_output, input, min_val, max_val)


def clamp_min_tensor_backward(grad_output: torch.Tensor, input: torch.Tensor, min_val: torch.Tensor, max_val: torch.Tensor):
    return clamp_min_tensor_backward_kernel(grad_output, input, min_val, max_val)


def clamp_max_tensor_backward(grad_output: torch.Tensor, input: torch.Tensor, min_val: torch.Tensor, max_val: torch.Tensor):
