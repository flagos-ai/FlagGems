...
@libentry()
@triton.autotune(
    configs=runtime.get_tuned_config("adaptive_max_pool3d_cooperative"),
...
def adaptive_max_pool3d(input: torch.Tensor, output_size, return_indices: bool = False):
    ...
    # The cooperative kernel is designed for global pooling (reshapes input
    # to 2D) and is only correct when all spatial output dims are 1.
