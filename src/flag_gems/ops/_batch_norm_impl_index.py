...
def _batch_norm_impl_index(
    ...
    """Batch normalization matching aten::_batch_norm_impl_index.

    Returns (output, save_mean, save_invstd, reserve, impl_index). The reserve
    tensor is empty and impl_index is 0 since this fallback path does not use
    cuDNN or MIOpen.
    """
    logger.debug("GEMS _BATCH_NORM_IMPL_INDEX")
