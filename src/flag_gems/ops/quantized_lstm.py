...
@triton.autotune(
    configs=[
        ...
        # Smaller tiles for the small batch / small hidden shapes, where the
        # 64-row tiles would leave most of the grid empty.
        triton.Config(
        ...
        # Wider N kept as a fallback for shapes where it happens to tile better.
        triton.Config(
