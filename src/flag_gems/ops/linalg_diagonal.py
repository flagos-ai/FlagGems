...
def diagonal_kernel(
    ...
    # ========== 3D ==========
        ...
        if dim1 == 0 and dim2 == 1:
            ...
            if offset >= 0:
                input_offset = (
                    c0 * in_stride2 + c1 * in_stride0 + (c1 + offset) * in_stride1
                )
            else:
                input_offset = (
                    c0 * in_stride2 + (c1 - offset) * in_stride0 + c1 * in_stride1
                )
            ...
            if offset >= 0:
                input_offset = (
                    c0 * in_stride1 + c1 * in_stride0 + (c1 + offset) * in_stride2
                )
            else:
                input_offset = (
                    c0 * in_stride1 + (c1 - offset) * in_stride0 + c1 * in_stride2
                )
            ...
            if offset >= 0:
                input_offset = (
                    c0 * in_stride0 + c1 * in_stride1 + (c1 + offset) * in_stride2
                )
            else:
                input_offset = (
                    c0 * in_stride0 + (c1 - offset) * in_stride1 + c1 * in_stride2
                )
        ...
        if dim1 == 0 and dim2 == 1:
            ...
            if offset >= 0:
                input_offset = (
                    ...
                    + c1 * in_stride3
                    + c2 * in_stride0
                    + (c2 + offset) * in_stride1
                )
            else:
                input_offset = (
                    c0 * in_stride2
                    + c1 * in_stride3
                    + (c2 - offset) * in_stride0
                    + c2 * in_stride1
                )
        elif dim1 == 0 and dim2 == 2:
