...
_FULL_CONFIG = (
    ...
    ("clamp.Tensor_backward", clamp_tensor_backward),
    ("clamp_min.Tensor_backward", clamp_min_tensor_backward),
    ("clamp_max.Tensor_backward", clamp_max_tensor_backward),
    ("clip", clip),
    ("clip_", clip_),
    ("col2im", col2im),
    ...
    ("maximum", maximum),
    ("maximum_backward", maximum_backward),
    ("mean", mean),
    ("mean.dim", mean_dim),
    ("median", median),
    ...
    ("min.dim", min_dim),
    ("minimum", minimum),
    ("minimum_backward", minimum_backward),
    ("mm", mm),
    ("mm.out", mm_out),
    ("mse_loss", mse_loss),
    ("mul.Tensor", mul),
    ...
    ("where.Self_backward", where_self_backward),
    ("where.Other_backward", where_other_backward),
    ("zero", zero),
    ("zero_", zero_),
    ("zero.out", zero_out),
    ("zeros", zeros),
