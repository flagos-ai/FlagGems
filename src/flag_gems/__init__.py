...
_FULL_CONFIG = (
    ...
    ("_foreach_abs", _foreach_abs),
    ("_foreach_abs_", _foreach_abs_),
    ("_foreach_acos", _foreach_acos),
    ("_foreach_acos_", _foreach_acos_),
    ("_foreach_add.List", _foreach_add_List),
    ("_foreach_add.Scalar", _foreach_add_Scalar),
    ("_foreach_add.ScalarList", _foreach_add_ScalarList),
    ("_foreach_add.Tensor", _foreach_add_Tensor),
    ("_foreach_add_.List", _foreach_add__List),
    ("_foreach_add_.Scalar", _foreach_add__Scalar),
    ("_foreach_add_.ScalarList", _foreach_add__ScalarList),
    ("_foreach_add_.Tensor", _foreach_add__Tensor),
    ("_foreach_addcdiv.Scalar", _foreach_addcdiv_Scalar),
    ("_foreach_addcdiv.ScalarList", _foreach_addcdiv_ScalarList),
    ("_foreach_addcdiv.Tensor", _foreach_addcdiv_Tensor),
    ("_foreach_addcdiv_.Scalar", _foreach_addcdiv__Scalar),
    ("_foreach_addcdiv_.ScalarList", _foreach_addcdiv__ScalarList),
    ("_foreach_addcdiv_.Tensor", _foreach_addcdiv__Tensor),
    ("_foreach_addcmul.Scalar", _foreach_addcmul_Scalar),
    ("_foreach_addcmul.ScalarList", _foreach_addcmul_ScalarList),
    ("_foreach_addcmul.Tensor", _foreach_addcmul_Tensor),
    ("_foreach_addcmul_.Scalar", _foreach_addcmul__Scalar),
    ("_foreach_addcmul_.ScalarList", _foreach_addcmul__ScalarList),
    ("_foreach_addcmul_.Tensor", _foreach_addcmul__Tensor),
    ("_foreach_asin", _foreach_asin),
    ("_foreach_asin_", _foreach_asin_),
    ("_foreach_atan", _foreach_atan),
    ("_foreach_atan_", _foreach_atan_),
    ("_foreach_ceil", _foreach_ceil),
    ("_foreach_ceil_", _foreach_ceil_),
    ("_foreach_clamp_max.List", _foreach_clamp_max_List),
    ("_foreach_clamp_max.Scalar", _foreach_clamp_max_Scalar),
    ("_foreach_clamp_max.ScalarList", _foreach_clamp_max_ScalarList),
    ("_foreach_clamp_max_.List", _foreach_clamp_max__List),
    ("_foreach_clamp_max_.Scalar", _foreach_clamp_max__Scalar),
    ("_foreach_clamp_max_.ScalarList", _foreach_clamp_max__ScalarList),
    ("_foreach_clamp_min.List", _foreach_clamp_min_List),
    ("_foreach_clamp_min.Scalar", _foreach_clamp_min_Scalar),
    ("_foreach_clamp_min.ScalarList", _foreach_clamp_min_ScalarList),
    ("_foreach_clamp_min_.List", _foreach_clamp_min__List),
    ("_foreach_clamp_min_.Scalar", _foreach_clamp_min__Scalar),
    ("_foreach_clamp_min_.ScalarList", _foreach_clamp_min__ScalarList),
    ("_foreach_copy", _foreach_copy),
    ("_foreach_copy_", _foreach_copy_),
    ("_foreach_cos", _foreach_cos),
    ("_foreach_cos_", _foreach_cos_),
    ("_foreach_cosh", _foreach_cosh),
    ("_foreach_cosh_", _foreach_cosh_),
    ("_foreach_div.List", _foreach_div_List),
    ("_foreach_div.Scalar", _foreach_div_Scalar),
    ("_foreach_div.ScalarList", _foreach_div_ScalarList),
    ("_foreach_div.Tensor", _foreach_div_Tensor),
    ("_foreach_div_.List", _foreach_div__List),
    ("_foreach_div_.Scalar", _foreach_div__Scalar),
    ("_foreach_div_.ScalarList", _foreach_div__ScalarList),
    ("_foreach_div_.Tensor", _foreach_div__Tensor),
    ("_foreach_erf", _foreach_erf),
    ("_foreach_erf_", _foreach_erf_),
    ("_foreach_erfc", _foreach_erfc),
    ("_foreach_erfc_", _foreach_erfc_),
    ("_foreach_exp", _foreach_exp),
    ("_foreach_exp_", _foreach_exp_),
    ("_foreach_expm1", _foreach_expm1),
    ("_foreach_expm1_", _foreach_expm1_),
    ("_foreach_floor", _foreach_floor),
    ("_foreach_floor_", _foreach_floor_),
    ("_foreach_frac", _foreach_frac),
    ("_foreach_frac_", _foreach_frac_),
    ("_foreach_lerp.List", _foreach_lerp_List),
    ("_foreach_lerp.Scalar", _foreach_lerp_Scalar),
    ("_foreach_lerp.ScalarList", _foreach_lerp_ScalarList),
    ("_foreach_lerp_.List", _foreach_lerp__List),
    ("_foreach_lerp_.Scalar", _foreach_lerp__Scalar),
    ("_foreach_lerp_.ScalarList", _foreach_lerp__ScalarList),
    ("_foreach_lgamma", _foreach_lgamma),
    ("_foreach_lgamma_", _foreach_lgamma_),
    ("_foreach_log", _foreach_log),
    ("_foreach_log10", _foreach_log10),
    ("_foreach_log10_", _foreach_log10_),
    ("_foreach_log1p", _foreach_log1p),
    ("_foreach_log1p_", _foreach_log1p_),
    ("_foreach_log2", _foreach_log2),
    ("_foreach_log2_", _foreach_log2_),
    ("_foreach_log_", _foreach_log_),
    ("_foreach_max", _foreach_max),
    ("_foreach_maximum.List", _foreach_maximum_List),
    ("_foreach_maximum.Scalar", _foreach_maximum_Scalar),
    ("_foreach_maximum.ScalarList", _foreach_maximum_ScalarList),
    ("_foreach_maximum_.List", _foreach_maximum__List),
    ("_foreach_maximum_.Scalar", _foreach_maximum__Scalar),
    ("_foreach_maximum_.ScalarList", _foreach_maximum__ScalarList),
    ("_foreach_minimum.List", _foreach_minimum_List),
    ("_foreach_minimum.Scalar", _foreach_minimum_Scalar),
    ("_foreach_minimum.ScalarList", _foreach_minimum_ScalarList),
    ("_foreach_minimum_.List", _foreach_minimum__List),
    ("_foreach_minimum_.Scalar", _foreach_minimum__Scalar),
    ("_foreach_minimum_.ScalarList", _foreach_minimum__ScalarList),
    ("_foreach_mul.List", _foreach_mul_List),
    ("_foreach_mul.Scalar", _foreach_mul_Scalar),
    ("_foreach_mul.ScalarList", _foreach_mul_ScalarList),
    ("_foreach_mul.Tensor", _foreach_mul_Tensor),
    ("_foreach_mul_.List", _foreach_mul__List),
    ("_foreach_mul_.Scalar", _foreach_mul__Scalar),
    ("_foreach_mul_.ScalarList", _foreach_mul__ScalarList),
    ("_foreach_mul_.Tensor", _foreach_mul__Tensor),
    ("_foreach_neg", _foreach_neg),
    ("_foreach_neg_", _foreach_neg_),
    ("_foreach_norm.Scalar", _foreach_norm),
    ("_foreach_pow.List", _foreach_pow_List),
    ("_foreach_pow.Scalar", _foreach_pow_Scalar),
    ("_foreach_pow.ScalarAndTensor", _foreach_pow_ScalarAndTensor),
    ("_foreach_pow.ScalarList", _foreach_pow_ScalarList),
    ...
    ("_foreach_round_", _foreach_round_),
    ("_foreach_rsqrt", _foreach_rsqrt),
    ("_foreach_rsqrt_", _foreach_rsqrt_),
    ("_foreach_sigmoid", _foreach_sigmoid),
    ("_foreach_sigmoid_", _foreach_sigmoid_),
    ("_foreach_sign", _foreach_sign),
    ("_foreach_sign_", _foreach_sign_),
    ("_foreach_sin", _foreach_sin),
    ("_foreach_sin_", _foreach_sin_),
    ("_foreach_sinh", _foreach_sinh),
    ("_foreach_sinh_", _foreach_sinh_),
    ("_foreach_sqrt", _foreach_sqrt),
    ("_foreach_sqrt_", _foreach_sqrt_),
    ("_foreach_sub.List", _foreach_sub_List),
    ("_foreach_sub.Scalar", _foreach_sub_Scalar),
    ("_foreach_sub.ScalarList", _foreach_sub_ScalarList),
    ("_foreach_sub_.List", _foreach_sub__List),
    ("_foreach_sub_.Scalar", _foreach_sub__Scalar),
    ("_foreach_sub_.ScalarList", _foreach_sub__ScalarList),
    ("_foreach_tan", _foreach_tan),
    ("_foreach_tan_", _foreach_tan_),
    ("_foreach_tanh", _foreach_tanh),
    ("_foreach_tanh_", _foreach_tanh_),
    ("_foreach_trunc", _foreach_trunc),
    ("_foreach_trunc_", _foreach_trunc_),
    ...
    ("adaptive_avg_pool3d_backward", adaptive_avg_pool3d_backward_grad_input),
    (
    ...
    ("hamming_window.periodic", hamming_window_periodic),
    ("hamming_window.periodic_alpha", hamming_window_periodic_alpha),
    ...
    ("linalg_matrix_rank.atol_rtol_float", linalg_matrix_rank),
    ("linalg_matrix_rank.atol_rtol_float_out", linalg_matrix_rank_out),
    ("linalg_matrix_rank.atol_rtol_tensor", linalg_matrix_rank),
    ("linalg_matrix_rank.atol_rtol_tensor_out", linalg_matrix_rank_out),
    ("linalg_matrix_rank.out", linalg_matrix_rank_tol_out),
    ("linalg_matrix_rank.out_tol_tensor", linalg_matrix_rank_tol_out),
    ("linalg_matrix_rank.tol_tensor", linalg_matrix_rank_tol),
    (
        "linalg_matrix_sqrth",
        linalg_matrix_sqrth,
