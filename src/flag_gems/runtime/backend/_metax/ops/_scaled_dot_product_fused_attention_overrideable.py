...
def _scaled_dot_product_fused_attention_overrideable(
    ...
    """Metax specialized implementation of _scaled_dot_product_fused_attention_overrideable.

    This function computes scaled dot-product attention with the interface expected by
    ...
    """
    logger.debug("GEMS_METAX _SCALED_DOT_PRODUCT_FUSED_ATTENTION_OVERRIDEABLE")

    # Currently only supports dropout_p=0.0
    assert dropout_p == 0.0, "Metax only supports dropout_p=0.0"
