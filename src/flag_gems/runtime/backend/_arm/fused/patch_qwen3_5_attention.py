...
try:
    ...
    @triton.jit
    def _flash_attn_kernel(q_ptr, k_ptr, v_ptr, out_ptr, seq_len,
        ...
        _tle_flash_attn_decode(q_ptr, k_ptr, v_ptr, out_ptr, seq_len, head_dim,
                               sm_scale, num_heads, num_kv_heads, stride_kn, stride_vn)
except ImportError:
