...
def w8a8_block_fp8_matmul(
    ...
    *,
    ...
    if out is None:
        ...
        assert out.shape == output_shape, "invalid out shape"
        assert out.device == device, "invalid out device"
        assert out.dtype == output_dtype, "invalid out dtype"
        c = out
