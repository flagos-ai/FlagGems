...
def fast_sin_cos_normalized(x, REDUCED: tl.constexpr):
    ...
    if REDUCED:
        sin_x = x * (
            ...
            + x2 * (-0.16666666666666666654
            + x2 * (0.00833333333333332876
            + x2 * (-0.00019841269841269616
            + x2 * 2.755731922398589e-6)))
        )
        cos_x = (
            1.0
            + x2 * (-0.49999999999999999983
            + x2 * (0.04166666666666666636
            + x2 * (-0.00138888888888888742
