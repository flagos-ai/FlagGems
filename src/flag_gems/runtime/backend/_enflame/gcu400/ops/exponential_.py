...
@libtuner(
    configs=[
        triton.Config({"BLOCK": 4096}, num_warps=2, num_stages=2),
        triton.Config({"BLOCK": 8192}, num_warps=2, num_stages=2),
        triton.Config({"BLOCK": 16384}, num_warps=4, num_stages=2),
        triton.Config({"BLOCK": 32768}, num_warps=4, num_stages=3),
        triton.Config({"BLOCK": 65536}, num_warps=4, num_stages=3),
    ],
    key=["N"],
)
