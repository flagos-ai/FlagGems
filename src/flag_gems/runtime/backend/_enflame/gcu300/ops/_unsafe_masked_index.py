...
def _unsafe_masked_index_kernel(
    ...
    # Load indices values (int32 on GCU300)
...
def _unsafe_masked_index(self, mask, indices, fill):
    logger.debug("GEMS_ENFLAME _UNSAFE_MASKED_INDEX")
    ...
    # GCU300 does not support 64-bit data types; indices are loaded as data in
    # the kernel and used as flat offsets, so downcast int64 to int32 (any supported
    # self.numel fits in int32).
