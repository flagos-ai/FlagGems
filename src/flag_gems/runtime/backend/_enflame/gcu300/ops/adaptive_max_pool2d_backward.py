...
def adaptive_max_pool2d_backward(
    ...
    """
    logger.debug("GEMS_ENFLAME ADAPTIVE_MAX_POOL2D_BACKWARD")
    ...
    # GCU300: torch passes the forward-pass indices as int64; the kernel loads
    # them straight off the pointer (int64 arithmetic), which GCU rejects.
    # Downcast to int32 before launch. Index elements index an in_h*in_w plane,
    # so int32 is exact for any practical tensor.
