"""Fast Hadamard Transform — KunlunXin vendor specialization.

Multi-pass butterfly via global memory with ping-pong buffers.
Each butterfly stage is a separate kernel launch.

Based on optimize-hadamard-transform-klx v1.
"""
