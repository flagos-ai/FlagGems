...
def _cheb_u(x_f32, n_f32):
    ...
    # k = 2..9
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 2.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 3.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 4.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 5.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 6.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 7.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
    res = tl.where(tl.abs(n_f32 - 8.0) < 0.5, uk, res); ukm2 = ukm1; ukm1 = uk
    uk = two_y * ukm1 - ukm2
