...
def igammac_func(a, x):
    ...
    term = 1.0 / a_f32
    sum_val = term
    term = term * x_f32 / (a_f32 + 1.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 2.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 3.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 4.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 5.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 6.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 7.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 8.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 9.0);  sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 10.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 11.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 12.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 13.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 14.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 15.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 16.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 17.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 18.0); sum_val = sum_val + term
    term = term * x_f32 / (a_f32 + 19.0); sum_val = sum_val + term
