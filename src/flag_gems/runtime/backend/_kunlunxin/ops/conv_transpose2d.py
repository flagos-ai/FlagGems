...
def _conv_transpose2d_output_kernel(
    ...
    for kh in tl.static_range(0, kernel_height):
        ...
        for kw in tl.static_range(0, kernel_width):
            input_col_numerator = safe_width + padding_width - kw * dilation_width
            ...
            for ci_base in tl.static_range(0, channel_blocks):
                input_channel_in_group = ci_base * BLOCK_CHANNELS + tl.arange(
                    0, BLOCK_CHANNELS
                )
                input_channel = (
                ...
                weight_offsets = (
                    (
                        input_channel * output_channels_per_group
