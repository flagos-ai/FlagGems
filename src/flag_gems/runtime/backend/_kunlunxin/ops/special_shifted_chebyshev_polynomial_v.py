...
def _shifted_v(x, n):
    ...
    v2 = tl.fma(coefficient, v1, -v0)
    v3 = tl.fma(coefficient, v2, -v1)
    v4 = tl.fma(coefficient, v3, -v2)
    v5 = tl.fma(coefficient, v4, -v3)
    v6 = tl.fma(coefficient, v5, -v4)
    v7 = tl.fma(coefficient, v6, -v5)
    v8 = tl.fma(coefficient, v7, -v6)
    v9 = tl.fma(coefficient, v8, -v7)
    v10 = tl.fma(coefficient, v9, -v8)
    v11 = tl.fma(coefficient, v10, -v9)
    v12 = tl.fma(coefficient, v11, -v10)
    v13 = tl.fma(coefficient, v12, -v11)
    v14 = tl.fma(coefficient, v13, -v12)
    v15 = tl.fma(coefficient, v14, -v13)
