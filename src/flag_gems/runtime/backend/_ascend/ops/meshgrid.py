...
def meshgrid(
    ...
    if device.type == "npu" or IS_NPU:
        if rank == 1:
            return tensors
        elif rank == 2:
            return _meshgrid_2d_pytorch(tensors, indexing)
        elif rank == 3:
            return _meshgrid_3d_pytorch(tensors, indexing)
        elif rank == 4:
            return _meshgrid_4d_pytorch(tensors, indexing)
        else:
